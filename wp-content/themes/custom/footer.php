<footer>
                                ...
                                <div class="recent-posts">
                                    ...
                                    <div class="recent-post">
                                        <div class="recent-post-thumb">
                                            <img src="<?php echo get_bloginfo('template_url');?>/images/recent-post1.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="recent-post">
                                        <div class="recent-post-thumb">
                                            <img src="<?php echo get_bloginfo('template_url');?>/images/recent-post2.jpg" alt="">
                                        </div>
                                        <div class="recent-post-info">
        ...
        <script src="<?php echo get_bloginfo('template_url');?>/js/vendor/jquery.gmap3.min.js"></script>
