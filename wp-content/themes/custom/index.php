                ...
                <div class="flexslider">
                  <ul class="slides">
                    <li>
                      ...
                      <img src="<?php echo get_bloginfo('template_url');?>/images/slide1.jpg" alt="" />
                    </li>
                    <li>
                        <div class="slider-caption">
                      ...
                      <img src="<?php echo get_bloginfo('template_url');?>/images/slide2.jpg" alt="" />
                    </li>
                    <li>
                        <div class="slider-caption">
                      ...
                      <img src="<?php echo get_bloginfo('template_url');?>/images/slide3.jpg" alt="" />
                    </li>
                  </ul>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                ...
                                <img src="<?php echo get_bloginfo('template_url');?>/images/under-heading.png" alt="" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="<?php echo get_bloginfo('template_url');?>/images/blogpost1.jpg" alt="" />
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="<?php echo get_bloginfo('template_url');?>/images/blogpost2.jpg" alt="" />
                                </div>
                                <div class="blog-content">
                                    <div class="content-show">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="<?php echo get_bloginfo('template_url');?>/images/blogpost3.jpg" alt="" />
                                </div>
                                <div class="blog-content">
                                    <div class="content-show">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="<?php echo get_bloginfo('template_url');?>/images/blogpost4.jpg" alt="" />
                                </div>
                                <div class="blog-content">
                                    <div class="content-show">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="<?php echo get_bloginfo('template_url');?>/images/blogpost5.jpg" alt="" />
                                </div>
                                <div class="blog-content">
                                    <div class="content-show">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-post">
                                <div class="blog-thumb">
                                    <img src="<?php echo get_bloginfo('template_url');?>/images/blogpost6.jpg" alt="" />
                                </div>
                                <div class="blog-content">
                                    <div class="content-show">
